...
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_01.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_dtm_temp
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_02.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_03.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_crowns1
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_04.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_ttops_temp
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_05.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_ttops_temp
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_06.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_grps_temp
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_07.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_grps_temp
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_08.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_grps_temp
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_09.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_fnl_temp
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_10.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
plt_fnl_temp2
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_11.jpeg"), dpi = "print", height = 7, width = 7, device = "jpeg")
```
...
(plt_fnl_temp + labs(subtitle = "Pre-Treatment")) +
  ...
  theme(plot.subtitle = element_text(size = 10, hjust = 0.5, face = "bold"), legend.title=element_text(size=8), legend.text=element_text(size = 7))
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_12.jpeg"), dpi = "print", height = 7, width = 9, device = "jpeg")
```
...
(plt_crowns1 + labs(subtitle = "Pre-Treatment") + 
  ...
  theme(plot.subtitle = element_text(size = 10, hjust = 0.5, face = "bold"), legend.title=element_text(size=8), legend.text=element_text(size = 7))
# save it
ggplot2::ggsave(paste0(delivery_dir, "/saf_13.jpeg"), dpi = "print", height = 7, width = 9, device = "jpeg")
```
